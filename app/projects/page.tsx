	...
	return (
		<main className="mx-auto max-w-7xl px-4 py-8">
			...
			<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
				{items.map((p) => (
					<Card key={p.id} className="hover:shadow-lg transition-shadow border-0 bg-white rounded-xl overflow-hidden">
						...
						<CardContent className="text-sm">
							...
							<div className="flex flex-wrap gap-2 mb-2">
								{p.tags.map((t) => (
									<span key={t} className="rounded-md border px-2 py-0.5 text-xs bg-gray-100">
										{t}
									</span>
								))}
							</div>
